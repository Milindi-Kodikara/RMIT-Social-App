...
//   var test = new LoginComponent();
//   test.state.username = 'sept';
//   test.state.password = 'whoopsiedoopysiewkojefowjefokwmoiwejfoiwnemcoiwenoinoi2n3oi1n34o21no12jn3o12j3n1kj23nk12j3nkjfnedkjvndfkjnekfjnvdkjvnekjrnwkejnfwkdfjnk2j3n4k234jnkjn';
//   test.loginClicked();
//   expect(test.state.hasLoginFailed).toBe(true);
// });
